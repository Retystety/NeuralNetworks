...
<h2>BaseNeuralNet</h2>
  ...
  <h4>Methods</h4>
     ...
     <br>void add_random(float min_val, float max_val) - Adds random value to each connection.
     <br>void multiply_random(float min_val, float max_val) - Multiplies each connection by random value.
